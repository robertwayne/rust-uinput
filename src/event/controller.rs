...
impl From<Misc> for Event {
    fn from(v: Misc) -> Event {
        Event::Controller(Controller::Misc(v))
    }
}
...
impl From<Mouse> for Event {
    fn from(v: Mouse) -> Event {
        Event::Controller(Controller::Mouse(v))
    }
}
...
impl From<JoyStick> for Event {
    fn from(v: JoyStick) -> Event {
        Event::Controller(Controller::JoyStick(v))
    }
}
...
impl From<GamePad> for Event {
    fn from(v: GamePad) -> Event {
        Event::Controller(Controller::GamePad(v))
    }
}
...
impl From<Digi> for Event {
    fn from(digi: Digi) -> Event {
        Event::Controller(Controller::Digi(digi))
    }
}
...
impl From<DPad> for Event {
    fn from(dpad: DPad) -> Event {
        Event::Controller(Controller::DPad(dpad))
    }
}
...
impl From<TriggerHappy> for Event {
    fn from(trigger_happy: TriggerHappy) -> Event {
        Event::Controller(Controller::TriggerHappy(trigger_happy))
    }
}
