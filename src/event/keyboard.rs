...
use super::{Code, Kind, Press, Release};
use ffi::*;
use libc::c_int;
...
impl From<Key> for Event {
    fn from(val: Key) -> Self {
        Event::Keyboard(Keyboard::Key(val))
    }
}
...
impl From<KeyPad> for Event {
    fn from(val: KeyPad) -> Self {
        Event::Keyboard(Keyboard::KeyPad(val))
    }
}
...
impl From<Misc> for Event {
    fn from(val: Misc) -> Self {
        Event::Keyboard(Keyboard::Misc(val))
    }
}
...
impl From<Function> for Event {
    fn from(val: Function) -> Self {
        Event::Keyboard(Keyboard::Function(val))
    }
}
...
impl From<Braille> for Event {
    fn from(val: Braille) -> Self {
        Event::Keyboard(Keyboard::Braille(val))
    }
}
...
impl From<Numeric> for Event {
    fn from(val: Numeric) -> Self {
        Event::Keyboard(Keyboard::Numeric(val))
    }
}
...
impl From<TouchPad> for Event {
    fn from(val: TouchPad) -> Self {
        Event::Keyboard(Keyboard::TouchPad(val))
    }
}
...
impl From<Camera> for Event {
    fn from(val: Camera) -> Self {
        Event::Keyboard(Keyboard::Camera(val))
    }
}
...
impl From<Attendant> for Event {
    fn from(val: Attendant) -> Self {
        Event::Keyboard(Keyboard::Attendant(val))
    }
}
...
impl From<InputAssist> for Event {
    fn from(val: InputAssist) -> Self {
        Event::Keyboard(Keyboard::InputAssist(val))
    }
}
