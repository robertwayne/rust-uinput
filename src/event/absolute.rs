...
impl From<Position> for Event {
    fn from(v: Position) -> Event {
        Event::Absolute(Absolute::Position(v))
    }
}
...
impl From<Wheel> for Event {
    fn from(v: Wheel) -> Event {
        Event::Absolute(Absolute::Wheel(v))
    }
}
...
impl From<Digi> for Event {
    fn from(v: Digi) -> Event {
        Event::Absolute(Absolute::Digi(v))
    }
}
...
impl From<Multi> for Event {
    fn from(v: Multi) -> Event {
        Event::Absolute(Absolute::Multi(v))
    }
}
